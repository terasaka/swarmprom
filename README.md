...
```bash
$ git clone https://github.com/terasaka/swarmprom.git
$ cd swarmprom
...
![Nodes](https://raw.githubusercontent.com/terasaka/swarmprom/master/grafana/screens/swarmprom-nodes-dash-v3.png)
...
![Nodes](https://raw.githubusercontent.com/terasaka/swarmprom/master/grafana/screens/swarmprom-services-dash-v3.png)
...
![Nodes](https://raw.githubusercontent.com/terasaka/swarmprom/master/grafana/screens/swarmprom-prometheus-dash-v3.png)
...
```yaml
  node-exporter:
    image: terasaka/swarmprom-node-exporter
    environment:
      - NODE_ID={{.Node.ID}}
    volumes:
...
```yaml
  prometheus:
    image: terasaka/swarmprom-prometheus
    command:
...
[swarm_node](https://github.com/terasaka/swarmprom/blob/master/prometheus/rules/swarm_node.rules) 
and [swarm_task](https://github.com/terasaka/swarmprom/blob/master/prometheus/rules/swarm_task.rules) 
...
```yaml
  alertmanager:
    image: terasaka/swarmprom-alertmanager
    environment:
      - SLACK_URL=${SLACK_URL}
...
![Alerts](https://raw.githubusercontent.com/terasaka/swarmprom/master/grafana/screens/alertmanager-slack-v2.png)
...
![Unsee](https://raw.githubusercontent.com/terasaka/swarmprom/master/grafana/screens/unsee.png)
...
![Scope](https://raw.githubusercontent.com/terasaka/swarmprom/master/grafana/screens/weave-scope.png)

![Scope Hosts](https://raw.githubusercontent.com/terasaka/swarmprom/master/grafana/screens/weave-scope-hosts-v2.png)
